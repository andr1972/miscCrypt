  temp = (t2 & (t4 ^ t3)) ^ (t6 & t0) ^ (t5 & t1) ^ t4;
  t7 = (((temp) >> 7) | (temp << 25)) +
       (((t7) >> 11) | (t7 << 21)) + W[0];
  temp = (t1 & (t3 ^ t2)) ^ (t5 & t7) ^ (t4 & t0) ^ t3;
  t6 = (((temp) >> 7) | (temp << 25)) +
       (((t6) >> 11) | (t6 << 21)) + W[1];
  temp = (t0 & (t2 ^ t1)) ^ (t4 & t6) ^ (t3 & t7) ^ t2;
  t5 = (((temp) >> 7) | (temp << 25)) +
       (((t5) >> 11) | (t5 << 21)) + W[2];
  temp = (t7 & (t1 ^ t0)) ^ (t3 & t5) ^ (t2 & t6) ^ t1;
  t4 = (((temp) >> 7) | (temp << 25)) +
       (((t4) >> 11) | (t4 << 21)) + W[3];
  temp = (t6 & (t0 ^ t7)) ^ (t2 & t4) ^ (t1 & t5) ^ t0;
  t3 = (((temp) >> 7) | (temp << 25)) +
       (((t3) >> 11) | (t3 << 21)) + W[4];
  temp = (t5 & (t7 ^ t6)) ^ (t1 & t3) ^ (t0 & t4) ^ t7;
  t2 = (((temp) >> 7) | (temp << 25)) +
       (((t2) >> 11) | (t2 << 21)) + W[5];
  temp = (t4 & (t6 ^ t5)) ^ (t0 & t2) ^ (t7 & t3) ^ t6;
  t1 = (((temp) >> 7) | (temp << 25)) +
       (((t1) >> 11) | (t1 << 21)) + W[6];
  temp = (t3 & (t5 ^ t4)) ^ (t7 & t1) ^ (t6 & t2) ^ t5;
  t0 = (((temp) >> 7) | (temp << 25)) +
       (((t0) >> 11) | (t0 << 21)) + W[7];
  ...
  temp = (t5 & ((t3 & (~t0)) ^ (t1 & t2) ^ t4 ^ t6)) ^ (t1 & (t3 ^ t2)) ^
	 (t0 & t2) ^ t6;
  t7 = (((temp) >> 7) | (temp << 25)) +
       (((t7) >> 11) | (t7 << 21)) + W[5] + 0x452821e6L;
  temp = (t4 & ((t2 & (~t7)) ^ (t0 & t1) ^ t3 ^ t5)) ^ (t0 & (t2 ^ t1)) ^
	 (t7 & t1) ^ t5;
  t6 = (((temp) >> 7) | (temp << 25)) +
       (((t6) >> 11) | (t6 << 21)) + W[14] + 0x38d01377L;
  temp = (t3 & ((t1 & (~t6)) ^ (t7 & t0) ^ t2 ^ t4)) ^ (t7 & (t1 ^ t0)) ^
	 (t6 & t0) ^ t4;
  t5 = (((temp) >> 7) | (temp << 25)) +
       (((t5) >> 11) | (t5 << 21)) + W[26] - 0x41ab9931L;
  temp = (t2 & ((t0 & (~t5)) ^ (t6 & t7) ^ t1 ^ t3)) ^ (t6 & (t0 ^ t7)) ^
	 (t5 & t7) ^ t3;
  t4 = (((temp) >> 7) | (temp << 25)) +
       (((t4) >> 11) | (t4 << 21)) + W[18] + 0x34e90c6cL;
  temp = (t1 & ((t7 & (~t4)) ^ (t5 & t6) ^ t0 ^ t2)) ^ (t5 & (t7 ^ t6)) ^
	 (t4 & t6) ^ t2;
  t3 = (((temp) >> 7) | (temp << 25)) +
       (((t3) >> 11) | (t3 << 21)) + W[11] - 0x3f53d649L;
  temp = (t0 & ((t6 & (~t3)) ^ (t4 & t5) ^ t7 ^ t1)) ^ (t4 & (t6 ^ t5)) ^
	 (t3 & t5) ^ t1;
  t2 = (((temp) >> 7) | (temp << 25)) +
       (((t2) >> 11) | (t2 << 21)) + W[28] - 0x3683af23L;
  temp = (t7 & ((t5 & (~t2)) ^ (t3 & t4) ^ t6 ^ t0)) ^ (t3 & (t5 ^ t4)) ^
	 (t2 & t4) ^ t0;
  t1 = (((temp) >> 7) | (temp << 25)) +
       (((t1) >> 11) | (t1 << 21)) + W[7] + 0x3f84d5b5L;
  temp = (t6 & ((t4 & (~t1)) ^ (t2 & t3) ^ t5 ^ t7)) ^ (t2 & (t4 ^ t3)) ^
	 (t1 & t3) ^ t7;
  t0 = (((temp) >> 7) | (temp << 25)) +
  ...
  temp = (t3 & ((t5 & t4) ^ t6 ^ t0)) ^ (t5 & t2) ^ (t4 & t1) ^ t0;
  t7 = (((temp) >> 7) | (temp << 25)) +
       (((t7) >> 11) | (t7 << 21)) + W[19] - 0x63cf2ac7L;
  temp = (t2 & ((t4 & t3) ^ t5 ^ t7)) ^ (t4 & t1) ^ (t3 & t0) ^ t7;
  t6 = (((temp) >> 7) | (temp << 25)) +
       (((t6) >> 11) | (t6 << 21)) + W[9] + 0x2af26013L;
  temp = (t1 & ((t3 & t2) ^ t4 ^ t6)) ^ (t3 & t0) ^ (t2 & t7) ^ t6;
  t5 = (((temp) >> 7) | (temp << 25)) +
       (((t5) >> 11) | (t5 << 21)) + W[4] - 0x3a2e4fddL;
  temp = (t0 & ((t2 & t1) ^ t3 ^ t5)) ^ (t2 & t7) ^ (t1 & t6) ^ t5;
  t4 = (((temp) >> 7) | (temp << 25)) +
       (((t4) >> 11) | (t4 << 21)) + W[20] + 0x286085f0L;
  temp = (t7 & ((t1 & t0) ^ t2 ^ t4)) ^ (t1 & t6) ^ (t0 & t5) ^ t4;
  t3 = (((temp) >> 7) | (temp << 25)) +
       (((t3) >> 11) | (t3 << 21)) + W[28] - 0x35be86e8L;
  temp = (t6 & ((t0 & t7) ^ t1 ^ t3)) ^ (t0 & t5) ^ (t7 & t4) ^ t3;
  t2 = (((temp) >> 7) | (temp << 25)) +
       (((t2) >> 11) | (t2 << 21)) + W[17] - 0x4724c711L;
  temp = (t5 & ((t7 & t6) ^ t0 ^ t2)) ^ (t7 & t4) ^ (t6 & t3) ^ t2;
  t1 = (((temp) >> 7) | (temp << 25)) +
       (((t1) >> 11) | (t1 << 21)) + W[8] - 0x71862350L;
  temp = (t4 & ((t6 & t5) ^ t7 ^ t1)) ^ (t6 & t3) ^ (t5 & t2) ^ t1;
  t0 = (((temp) >> 7) | (temp << 25)) +
